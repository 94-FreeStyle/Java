...
public class UploadImg extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String savepath = this.getServletContext().getRealPath("/clothes_img");
		...
		AllDomain.imgname = filename;
		request.getRequestDispatcher("/WEB-INF/AdminJSP/AMR_AddClothes.jsp")
