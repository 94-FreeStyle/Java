...
<body>
	...
	<div id=all>
						...
						<c:forEach items="${cartss}" var="c">
							<tr class="ttr">
								<td class="t1" align="center" valign="middle"><img
									src="${c.image}" width="100px" height="100px"></td>
								<td class="t5" align="center" valign="middle">${c.name}</td>
								<td class="t2" align="center" valign="middle">￥${c.price}</td>
								<td class="t3" align="center" valign="middle">${c.num}件</td>
								<td class="t4" align="center" valign="middle">￥${c.dmoney}</td>
							</tr>
							<tr>
								<td colspan="5"><hr /></td>
							</tr>
		...
		<div id="buy">
			<div class="aaa">
				总计：<b>￥${allmon}</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
					type="button" value="支付" class="jie" onclick="vpay()" />
			</div>
		</div>
	</div>
</body>
