...
<script type="text/javascript">
	function _go(select) {
		...
		location = "<c:url value='/servlet/MainRightDisplay?pageCode='/>"
				+ value;
	}
</script>
</head>
...
<body>
	<div class="all">
		<div id="query">
			<form
				action="/MicroClothesShop/servlet/QueryClothes?pageCode=1" method="post">
				<p>
		...
		<div id="ye">
			<p>
				...
				<c:if test="${pb.pageCode>1 }">
					<a
						href="<c:url value='/servlet/MainRightDisplay?pageCode=${pb.pageCode-1 }'/>">&nbsp;&nbsp;&nbsp;上一页
					</a>
				</c:if>
				&nbsp;&nbsp;&nbsp;
				...
				<c:forEach begin="${begin }" end="${end }" var="i">
					<c:choose>
						...
						<c:otherwise>
							<a
								href="<c:url value='/servlet/MainRightDisplay?pageCode=${i }'/>">[${i}]
							</a>
						</c:otherwise>
					</c:choose>
				</c:forEach>
				<c:if test="${pb.pageCode<pb.totlePage }">
					<a
						href="<c:url value='/servlet/MainRightDisplay?pageCode=${pb.pageCode+1 }'/>">&nbsp;&nbsp;&nbsp;下一页
					</a>
				</c:if>
				&nbsp;&nbsp;&nbsp; 跳到第 <select name="pageCode" onchange="_go(this)">
