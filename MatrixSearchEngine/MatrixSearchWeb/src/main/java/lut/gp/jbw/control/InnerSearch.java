...
public class InnerSearch extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(InnerSearch.class);
        ...
        if (requestParams.length() != 0) {
            ...
            if (!cache.containsKey(new CacheKey(searchCon))) {
                ...
                if (sortedRes.isEmpty()) {
                    ...
                    logger.info("no page for request:" + requestParams);
                } else {
                    ...
                    logger.info("cache put:" + new CacheKey(searchCon).toString());
                }
            }
            String con = "";
